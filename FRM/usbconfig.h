...
#define  USB_CFG_VENDOR_ID  0x11, 0x11  /* 5824 in dec, stands for VOTI */
/* USB vendor ID for the device, low byte first. If you have registered your
 * own Vendor ID, define it here. Otherwise you use obdev's free shared
 * VID/PID pair. Be sure to read USBID-License.txt for rules!
 */
#define USB_CFG_DEVICE_ID   0x22, 0x022  /* 1500 in dec, obdev's free PID */
 ...
 */
#define USB_CFG_VENDOR_NAME     'A', 'r', 't', 'e', 'm', ' ', 'S', 'o', 'f', 't', 'w', 'a', 'r', 'e'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'U', 'S', 'B', 'A', 'V', 'R', '2', '3', '1', '3'
