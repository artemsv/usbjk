// DevMon2.cpp : main Windows Service project file.

#include "stdafx.h"
#include <string.h>
#include "DevMon2WinService.h"

using namespace DevMon2;
using namespace System::Text;
using namespace System::Security::Policy;
using namespace System::Reflection;

//To install/uninstall the service, type: "DevMon2.exe -Install [-u]"
int _tmain(int argc, _TCHAR* argv[])
{
	...
	{
		ServiceBase::Run(gcnew DevMon2WinService());
	}
}
