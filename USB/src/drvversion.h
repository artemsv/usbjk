...
#define DRV_YEAR               2008 // current year or timespan (e.g. 2003-2007)
#define TEXT_WEBSITE           http:/##/www.yoursite.net // website
#define TEXT_PRODUCTNAME       USB Guard Sensor // product's name
#define TEXT_FILEDESC          USB Guard Sensor driver // component description
#define TEXT_COMPANY           Sokol Software // company
#define TEXT_MODULE            Driver1 // module name
...
#define TEXT_INTERNALNAME      usbjk.sys // copyright information
